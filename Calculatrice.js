...
document.getElementById("suppression").addEventListener("click",function(){ud('<');});

document.getElementById("plus").addEventListener("click",function(){ud('+');});
document.getElementById("moins").addEventListener("click",function(){ud('-');});
document.getElementById("fois").addEventListener("click",function(){ud('*');});
